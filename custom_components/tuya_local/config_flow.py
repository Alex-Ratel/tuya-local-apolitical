...
DEVICE_DETAILS_URL = (
    "https://github.com/Alex-Ratel/tuya-local-apolitical/blob/main/DEVICE_DETAILS.md"
...
class ConfigFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_select_type(self, user_input=None):
        ...
        _LOGGER.warning(
            "Include the previous log messages with any new device request to https://github.com/Alex-Ratel/tuya-local-apolitical/issues/",
        )
        if type_options:
